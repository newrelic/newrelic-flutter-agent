...
In android/settings.gradle:
   ...
   plugins {
      ...
      id "com.newrelic.agent.android" version "7.7.5" apply false // <-- include this
   }
   ```
...
[New Relic Explorers Hub topic](https://discuss.newrelic.com/tag/newrelic-flutter-agent)
