...
void main() {
  ...
  test(
      'expect newrelic custom http client DELETE URL',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client GET',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client DELETE',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client POST URL',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).postUrl(any))
            .thenAnswer((_) async => mockRequest);
  ...
  test(
      'expect newrelic custom http client POST ',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client WRITE Body',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).postUrl(any))
            .thenAnswer((_) async => mockRequest);
  ...
  test(
      'expect newrelic custom http client PUT URL',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).putUrl(any))
            .thenAnswer((_) async => mockRequest);
  ...
  test(
      'expect newrelic custom http client PUT ',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client HEAD URL',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).headUrl(any))
            .thenAnswer((_) async => mockRequest);
  ...
  test(
      'expect newrelic custom http client HEAD ',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client OPEN URL',
          () async {
        when<dynamic>(
  ...
  test(
      'expect newrelic custom http client OPEN ',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).open(any,any,any,any))
            .thenAnswer((_) async => mockRequest);
  ...
  test(
      'expect newrelic custom http client PATCH URL',
          () async {
        when<dynamic>(
            (newRelicHttpClient.client as MockHttpClient).patchUrl(any))
            .thenAnswer((_) async => mockRequest);
  ...
  test('expect newrelic custom http client to set client autoUncompress',
        ...
        verify((newRelicHttpClient.client as MockHttpClient).autoUncompress =
        false)
            .called(1);
      });
  ...
  test('expect newrelic custom http client to get client userAgent',
          () async {
  ...
  test('expect newrelic custom http client to set client userAgent',
          () async {
  ...
  test('expect newrelic custom http client to call client addClientCredentials',
        ...
        newRelicHttpClient.addCredentials(
  ...
  test('expect newrelic custom http client to call client addProxyCredentials',
        ...
        final MockHttpClientCredentials clientCredentials =
        MockHttpClientCredentials();
        newRelicHttpClient.addProxyCredentials(
  ...
  test(
      'expect newrelic custom http client to set client find Proxy',
          () async {
        final String Function(Uri uri) f =
            (Uri uri) => "test";
  ...
  test(' Creating Newrelic Http Client Using NewRelicHttpOverrides', () async {
    ...
    expect(httpOverrides.createHttpClient(SecurityContext()).runtimeType, NewRelicHttpClient().runtimeType);
    final httpOverrides2 = NewRelicHttpOverrides(createHttpClientFn: (context) => HttpClient(), findProxyFromEnvironmentFn: (uri, env) => "");
    expect(httpOverrides2.createHttpClient(SecurityContext()).runtimeType, NewRelicHttpClient().runtimeType);
