...
// in newrelic_mobile/example/ios/.symlinks/plugins/newrelic_mobile/test/newrelic_http_client_test.dart.
...
import 'package:newrelic_mobile/newrelic_http_client.dart' as _i5;
...
/// A class which mocks [NewRelicHttpClientRequest].
///
/// See the documentation for Mockito's code generation for more information.
class MockNewRelicHttpClientRequest extends _i1.Mock
    implements _i5.NewRelicHttpClientRequest {
  MockNewRelicHttpClientRequest() {
    _i1.throwOnMissingStub(this);
  }
  ...
  int get timestamp =>
      (super.noSuchMethod(Invocation.getter(#timestamp), returnValue: 0)
          as int);
  @override
  Map<String, dynamic> get traceData =>
      (super.noSuchMethod(Invocation.getter(#traceData),
          returnValue: <String, dynamic>{}) as Map<String, dynamic>);
  @override
  set traceData(Map<String, dynamic>? _traceData) =>
      super.noSuchMethod(Invocation.setter(#traceData, _traceData),
          returnValueForMissingStub: null);
  @override
  _i3.Encoding get encoding => (super.noSuchMethod(Invocation.getter(#encoding),
      returnValue: _FakeEncoding_5()) as _i3.Encoding);
  @override
  set encoding(_i3.Encoding? value) =>
...
/// A class which mocks [NewRelicHttpClientResponse].
///
/// See the documentation for Mockito's code generation for more information.
class MockNewRelicHttpClientResponse extends _i1.Mock
    implements _i5.NewRelicHttpClientResponse {
  MockNewRelicHttpClientResponse() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.HttpClientRequest get request =>
      (super.noSuchMethod(Invocation.getter(#request),
          returnValue: _FakeHttpClientRequest_1()) as _i2.HttpClientRequest);
  @override
  int get timestamp =>
      (super.noSuchMethod(Invocation.getter(#timestamp), returnValue: 0)
          as int);
  @override
  set responseData(String? _responseData) =>
      super.noSuchMethod(Invocation.setter(#responseData, _responseData),
          returnValueForMissingStub: null);
  @override
  set traceData(dynamic _traceData) =>
      super.noSuchMethod(Invocation.setter(#traceData, _traceData),
          returnValueForMissingStub: null);
  @override
  _i2.HttpClientResponseCompressionState get compressionState =>
