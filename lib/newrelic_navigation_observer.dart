...
class NewRelicNavigationObserver extends RouteObserver<PageRoute<dynamic>> {
  ...
  void _addBreadcrumb(String methodType,RouteSettings? fromRoute, RouteSettings? toRoute) {
    ...
    NewrelicMobile.recordBreadcrumb(breadCrumbName,eventAttributes: attributes);
  }
