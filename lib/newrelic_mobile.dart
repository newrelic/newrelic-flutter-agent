...
class NewrelicMobile {
  ...
  static void recordError(Object error,StackTrace? stackTrace,{bool isFatal = false}) async {
  ...
  static Future<bool> recordBreadcrumb(String name, { Map<String, dynamic>? eventAttributes} ) async {
    final Map<String, dynamic> params = <String, dynamic> {
      'name': name,
